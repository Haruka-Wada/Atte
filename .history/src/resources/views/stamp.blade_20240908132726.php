...
<div class="main-container">
    ...
    <div class="main-item">
        <form action="/workStart" method="post" class="main-item__form">
            @csrf
            <button class="main-button" class="main-item__form">勤務開始</button>
        </form>
        <form action="">
            <button class="main-button" class="main-item__form">勤務終了</button>
        </form>
        <form action="">
            <button class="main-button" class="main-item__form">休憩開始</button>
        </form>
        <form action="">
            <button class="main-button" class="main-item__form">休憩終了</button>
        </form>
    </div>
</div>
@endsection