...
<ul class="header-nav">
    ...
    <li class="header-nav__item"><button class="header-nav__button" onclick="location.href='localhost/attendance'">日付一覧</button></li>
...
<div class="main-container">
    <div class="main-date">
        <form action="/attendance/dt" method="get">
            @csrf
