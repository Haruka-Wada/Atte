...
<div class="main-container">
    ...
    <table class="main-table">
        ...
        <tr>
            <td>{{ $workTimes->user_name }}</td>
            <td>{{ $workTimes->start_time }}</td>
            <td>{{ $workTimes->end_time ? $workTime->end_time : '' }}</td>
            <td>{{ $workTimes->restTime }}</td>
            <td>{{ $workTimes->WorkDiffInSeconds() }}</td>
        </tr>
        @endforeach
    </table>
