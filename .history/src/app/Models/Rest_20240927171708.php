...
class Rest extends Model
{
    ...
    public function totalDiffInSeconds($work, $restDiffInSeconds) {
        $oldRestTime = new Carbon($work->rest_time);
        $restTime = new Carbon($restDiffInSeconds);
        $totalDiffInSeconds = $oldRestTime->floatDiffInSeconds($restTime);
        $rest_time = $this->restTime($totalDiffInSeconds);
