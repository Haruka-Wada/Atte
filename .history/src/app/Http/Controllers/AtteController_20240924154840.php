...
class AtteController extends Controller
{
    ...
    public function attendance() {
        ...
        foreach($works as $work) {
            ...
            $restTime = $rest->restDiffInSeconds()->where('work_id', $work->id)->get();
        }
        $workTime = ['user_name' => '$user_name','start_time' => 'start_time']
        return view('attendance', compact('dt', 'works', 'restTime'));
    }
