    ...
    public function attendance() {
        ...
        foreach($works as $work) {
            ...
            $workTimes = [
                ...
                'rest_time' => $rest->restDiffInSeconds()->where('work_id'),
                'work_time' => $work_time
            ];
            ...
            $rest_time = $rest->restDiffInSeconds()->where('work_id', $work->id);
            $work_time = $work->WorkDiffInSeconds();
        }
