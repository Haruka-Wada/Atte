...
class AtteController extends Controller
{
    ...
    public function attendance() {
        ...
        foreach($works as $work) {
            $rest = Rest::with('work')->where('work_id', $work->id)->get();
            if(!empty($rest->end_time)) {
                ...
                return $rest = sprintf('%02d', $hours) . ':' . sprintf('%02d', $minutes) . ':' . sprintf('%02d', $seconds);
            }
        return view('attendance', compact('dt', 'works', 'rest'));
    }
